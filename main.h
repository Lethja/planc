...
(WebKitWebView *) gtk_notebook_get_nth_page(notebook ,gtk_notebook_get_current_page(notebook))

#define WK_CURRENT_TAB_WIDGET(notebook) \
(GtkWidget *) gtk_notebook_get_nth_page(notebook ,gtk_notebook_get_current_page(notebook))
